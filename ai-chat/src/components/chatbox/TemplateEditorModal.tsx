      ...
      <div className="w-full max-w-lg rounded-lg bg-white p-5 shadow-xl">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-base font-semibold text-gray-900">
            {templateDraft.id ? t('templateEditor.editTitle') : t('templateEditor.newTitle')}
          </h2>
          <button
            onClick={onClose}
        ...
        <label className="mb-3 block">
          <span className="mb-1 block text-sm font-medium text-gray-700">{t('templateEditor.title')}</span>
          <input
        ...
        <label className="mb-4 block">
          <span className="mb-1 block text-sm font-medium text-gray-700">{t('templateEditor.content')}</span>
          <textarea
