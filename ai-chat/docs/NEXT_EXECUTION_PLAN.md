...
Public distribution infrastructure hold after the 2026-05-25 ownership refresh.
...
- Keep public distribution explicitly blocked until the remaining signing, timestamp, and release-metadata prerequisites exist.
...
4. Keep public distribution blocked until certificate inputs, timestamp authorities, release metadata publication, and rollback metadata details exist, with blocker items 1-5 tracked in `docs/PUBLIC_DISTRIBUTION_OWNERSHIP.md`.
...
- Ownership assignment is complete for blocker items 1, 4, and 5; blocker items 2 and 3 still need non-owner release-infrastructure details.
...
- public distribution gates remain explicitly blocked or fully documented with owners plus remaining infrastructure details.
